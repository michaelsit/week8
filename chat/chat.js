...
firebase.auth().onAuthStateChanged(async function(user) {
  ...
  if (user) {
    ...
    // 🔥 Step 4 begins here
    // get a reference to the "submit message" button (. for class / # for id)
    ...
    submitButton.addEventListener('click',async function(event) {
      ...
      let messageInput = messageBox.value
      ...
      let url = `https://kiei451.com/.netlify/functions/create_message?userName=${userName}&body=${messageInput}`
